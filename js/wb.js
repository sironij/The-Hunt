...
"img1":"images/whatsbehind/methods1.png","descrizione3":"A very important process for our research was fact-checking.","descrizione4":"We compared the content that we found with resources and articles from a wide range of sources, in order to understand the reliability of the information spread and to identify misleading content.","img1":"images/whatsbehind/methods1.png","img2":"images/whatsbehind/methods2.png","img3":"images/whatsbehind/methods3.png","img4":"images/whatsbehind/methods4.png","img5":"images/whatsbehind/methods5.png","img6":"images/whatsbehind/methods6.png","img7":"images/whatsbehind/methods7.png","img8":"images/whatsbehind/methods8.png"},
...
function iniziale (seziones){
    $('#wb-txt').text(seziones.descrizione) ;
        $('.wb-documentation').append("<div'><div class='wb-preview'><a href='https://densitydesign.github.io/teaching-dd16/course-results/es02/group03/question-1/' target='_blank'><img  src="+seziones.img1+"></a></div>  <div class='fileName'><p>"+seziones.imgname1+"</p></div></div>")
